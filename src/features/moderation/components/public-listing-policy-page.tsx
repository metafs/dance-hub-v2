  ...
  return (
    <div className="container container-narrow">
      ...
      <Section id="policy-scope" size="small" title="A. 対象">
        ...
        />
        <p className="prose">
          ジャンルで除外しません。コンテンポラリー、バレエ、ストリート、舞踏、日本舞踊、民族舞踊、フィジカルシアター、パフォーマンスアート、ダンスを含む演劇は、すべて対象です。コンテスト・バトル、屋外のパフォーマンスも対象です。教室・スクールの発表会は除外せず、種別で分けて掲載します。定期的なレギュラーレッスンは対象外です。
        </p>
      </Section>
